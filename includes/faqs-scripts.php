...
function faqs_management_enqueue_scripts() {
    ...
    wp_enqueue_style('faq-category-css', plugins_url('../assets/css/faq-category.css', __FILE__));
    wp_enqueue_style('faq-tag-css', plugins_url('../assets/css/faq-tag.css', __FILE__));
   ...
   wp_enqueue_script('faq-filter', plugins_url('../assets/js/faq-filter.js', __FILE__), array('jquery'), null, true);
